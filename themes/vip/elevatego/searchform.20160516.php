...
<!--	<button class="morphsearch-submit picon picon-0033-search-find-zoom" type="submit">Search</button>-->
<!--</form>-->
...
<div id="div_start">
	<button id="start_button" onclick="startButton(event)">
		<img alt="Start" id="start_img" src="<?php echo get_template_directory_uri () ?>/gs-assets/mic.gif"></button>
</div>
...
<form role="search" method="get" class="morphsearch-form" id="create" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label>
		...
		<input type="search" class="morphsearch-input" id="elevatesearchfield" placeholder="Search..." value="<?php echo get_search_query(); ?>" name="s" autocomplete="off" />
	</label>
	<button type="submit" class="morphsearch-submit picon picon-0033-search-find-zoom"></button>
</form>

<img id="loading_spinner"
	 src="https://i2.wp.com/www.dhp11.com/foswiki/pub/Internal/2012-06-12/spinner.gif"
	 style="display:none">
<div id="created">
...
</div><script src="<?php echo get_template_directory_uri () ?>/gs-assets/chrome.min.js">
</script>  <script>
	var langs =
		[['Afrikaans',       ['af-ZA']],
...
//			elevatesearchfield.innerHTML = linebreak(final_transcript);
			interim_span.innerHTML = linebreak(interim_transcript);
			//document.getElementById('elevatesearchfield').value = linebreak(interim_transcript);
