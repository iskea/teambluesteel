<form method="POST" action="contact_form_send_message" class="respond-form tt-custom-form" data-parsley-validate>
	<?php 
	$i=0;	//unnamed fields counter
	foreach($rows as $row) : ?> 
		<div class="row row-fit-40"><!-- Start Row -->
			<?php foreach( $row['columns'] as $column ) : ?> 
				<div class="col-md-<?php echo esc_attr($column['size']*2); ?>"><!-- Start Column -->
