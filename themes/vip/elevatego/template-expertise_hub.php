						...
						<?php if ($count==0) { ?>
							<div class="col-sm-12 col-md-6 primary-article dark-gradient-btm" style="background-image: url(<?php echo $a_articles[$a_featured_article]['img'] ?>)">
								<div class="col-md-11 caption">
									<h3><a href="<?php echo get_permalink($a_articles[$a_featured_article]['ID']) ?>" class="text-white"><?php echo $a_articles[$a_featured_article]['post_title'] ?></a></h3>
									<h5>
						...
						<?php } else { ?>
							<div class="col-sm-12 col-md-12 secondary-article" style="background-image: url(<?php echo $a_articles[$a_featured_article]['img'] ?>)">
								<div class="col-md-9 col-md-offset-4 bg-white caption">
									<h3><a href="<?php echo get_permalink($a_articles[$a_featured_article]['ID']) ?>" class="text-black"><?php echo $a_articles[$a_featured_article]['post_title'] ?></a></h3>
									<h5>
										<small class="article-date"><strong><?php echo $a_articles[$a_featured_article]['post_date'] ?></strong> |</small>
										<small class="article-views"> <em><a href="<?php echo get_home_url()?>/expertise-author?author_post_id=<?php echo get_the_id($a_articles[$a_featured_article]['meta']['elv_posts_authors'][0]); ?>" class=""><?php echo get_the_title($a_articles[$a_featured_article]['meta']['elv_posts_authors'][0]); ?></a></em></small>
									</h5>
						...
						<div class=" col-md-3 l-padding-b-1">
							<div class="bg-blue feature-tile fixed-height-420 dark-gradient-btm" style="background: url(<?php echo the_post_thumbnail_url(); ?>) 50%;">
								<div class="tile-body text-center">
									<img src="">
									<h3 class="text-white">
										<a href="<?php echo get_home_url()?>/lifestages/starting-your-career" class="text-white">Starting your career</a>
									</h3>
								</div>
							</div>
						</div>
						<div class=" col-md-3 l-padding-b-1">
							<div class="bg-blue feature-tile fixed-height-420 dark-gradient-btm" style="background: url(<?php echo the_post_thumbnail_url(); ?>) 50%;">
								<div class="tile-body text-center">
									<img src="">
									<h3 class="text-white">
										<a href="<?php echo get_home_url()?>/lifestages/starting-your-career" class="text-white">Getting financially savvy</a>
									</h3>
								</div>
							</div>
						</div>
						<div class=" col-md-3 l-padding-b-1">
							<div class="bg-blue feature-tile fixed-height-420 dark-gradient-btm" style="background: url(<?php echo the_post_thumbnail_url(); ?>) 50%;">
								<div class="tile-body text-center">
									<img src="">
									<h3 class="text-white">
										<a href="<?php echo get_home_url()?>/lifestages/starting-your-career" class="text-white">Building<br />wealth</a>
									</h3>
								</div>
							</div>
						</div>
						<div class=" col-md-3 l-padding-b-1">
							<div class="bg-blue feature-tile fixed-height-420 dark-gradient-btm" style="background: url(<?php echo the_post_thumbnail_url(); ?>) 50%;">
								<div class="tile-body text-center">
									<img src="">
									<h3 class="text-white">
										<a href="<?php echo get_home_url()?>/lifestages/starting-your-career" class="text-white">Preparing for retirement</a>
									</h3>
								</div>
							</div>
						</div>
